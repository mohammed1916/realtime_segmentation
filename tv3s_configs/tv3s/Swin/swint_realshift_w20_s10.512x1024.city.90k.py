...
model = dict(
    ...
    pretrained='/home/data_/workdir/2024/May_VideoSegmentMamba/VSFM/pretrained/swin_tiny_patch4_window7_224_22k.pth',
    backbone=dict(
        type='d2_Swint',
        style='pytorch'),
    decode_head=dict(
...
# optimizer
optimizer = dict(_delete_=True, type='AdamW', lr=2e-4, betas=(0.9, 0.999), eps=1e-8, weight_decay=0.05,
